module.exports = {
    handler : function (host, apiKeys, done, req, res) {
        ...
        var url = require('url');
        var callback = host+"auth/recruit/auth";
        var OAlib = require('oauth').OAuth;
        var OA = new OAlib('http://admin:ikea@recruit.hubinga.com:8084/_oauth/request_token'
         , 'http://admin:ikea@recruit.hubinga.com:8084/_oauth/authorize'
         , apiKeys.appKey
         , apiKeys.appSecret
         , '1.0'
         , callback
        ...
        OA.getOAuthRequestToken( { oauth_callback: callback }, function (error, oauth_token, oauth_token_secret, oauth_authorize_url, additionalParameters) {
            ...
            res.redirect('http://admin:ikea@recruit.hubinga.com:8084/_oauth/authorize?oauth_token=' + oauth_token);
        });
    }
}
